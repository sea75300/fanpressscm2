...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'upload_dir' => FPUPLOADFOLDER,
            'upload_url' => FPUPLOADFOLDER,
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
        ...
        if ($initialize) {
            ...
            $GLOBALS['fpFileSystem']->rebuildFileStore();
        }
    }
    ...
    protected function validate($uploaded_file, $file, $error, $index) {
        ...
        if(!in_array($file->type, $allowedFileTypes)) return false;        
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error, $index = null, $content_range = null) {        
        $GLOBALS['fpFileSystem']->escapeFileName($name);
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
            ...
            $file_path = $this->get_upload_path($GLOBALS['fpFileSystem']->escapeFileName($file->name));
