jQuery.noConflict();
jQuery(function() {
        jQuery('.fp-readmore-block-text').hide();
        
        jQuery('.fp-readmore-block-link').click(function(){
            jQuery(this).parent().children('.fp-readmore-block-text').fadeToggle();
            return false;
        });
        
        jQuery('.commentMentionLink').click(function() {
           insertSmilieToComment('@#' + jQuery(this).attr('id'));
           return false;
        });
...
/* Smilies in Kommentar einfügen */
/**
 * based on http://www.php.de/html-usability-und-barrierefreiheit/34508-onclick-input-text-area.html
 * Auther:
 */
function insertSmilieToComment(smiliecode) {
  aTag = smiliecode;
  eTag = "";
  var input = document.forms['cform'].elements['cmttext'];
  input.focus();
